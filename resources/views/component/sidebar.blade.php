<div class="drawer-side">
    ...
    <ul class="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
        ...
        <!-- Menu Navigasi -->
        <li><a class="{{ request()->routeIs('dashboard') ? 'active bg-base-300 font-semibold' : '' }}">
        ...
        <li>
            <details open="">
                ...
                <ul>
                    <li><a class="{{ request()->routeIs('service.index') ? 'active bg-base-300 font-semibold' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a class="{{ request()->routeIs('report.index') ? 'active bg-base-300 font-semibold' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
