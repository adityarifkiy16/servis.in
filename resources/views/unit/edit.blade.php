...
@section('content')
    ...
    <div class="w-full max-w-7xl px-6 py-4">
        ...
        <form action="{{ route('unit.update', $unit->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            <!-- Product -->
            <div class="form-control">
                <label class="label">
                    <span class="label-text">Name Unit</span>
                </label>
            ...
            <div class="flex justify-end gap-3 mt-6">
                <a href="{{ route('unit.index') }}" class="btn btn-ghost">Cancel</a>
