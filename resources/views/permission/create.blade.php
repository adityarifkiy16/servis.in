...
@section('content')
    ...
    <div class="w-full max-w-7xl px-6 py-4">
        <h2 class="text-2xl font-bold mb-6">Create Permissions</h2>
        <p class="text-gray-500 dark:text-gray-400 text-sm mb-6">Please fill in the form below to create permission</p>
